    ...
    render() {
        ...
        for(let item in this.props.msgDetails){
            if(isNaN(item)){
                ...
                listContent.push(
                    <tr key={cnt}
                        className="text-violet text-start">
        ...
        return (
            <div>
                <Table striped bordered hover className="text-left w-100 border-violet">
                    <thead>
                        <tr>
                            <th colSpan="2"
                ...
                <div className="w-100 text-center">
                    <Button variant={"outline-dark rounded-pill text-violet border-violet me-2"}
                        className="float-left"
                        onClick={this.delete.bind(this)}>
                        Delete
                    </Button>
                    <Button variant={"outline-dark rounded-pill text-violet border-violet"}
