...
class MessageTable extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Table striped bordered hover className="text-start w-100 border-violet">
                    <thead>
                        <tr className="text-violet border-violet">
                            <th>ID</th>
                            <th>Name</th>
                ...
                <div className="w-100 text-end">
                    <Button variant={"outline-dark text-violet border-violet me-2"}
                        onClick={this.prevPage.bind(this)}>
                        &lt;
                    </Button>
                    <Button variant={"outline-dark text-violet border-violet"}
